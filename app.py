...
POLLUTANT_THRESHOLDS = {
    ...
    "CO": {
        ...
        "bands": [
            ...
            (9.4, 12.4, "Poor"),
            (12.4, 15.4, "Very Poor"),
            (15.4, float("inf"), "Hazardous"),
        ],
    },
    "CO2": {
        "unit": "ppm",
        "hazardous_threshold": 2000,
        "max_recorded": 10000,
        "bands": [
            (0, 600, "Good"),
            (600, 1000, "Acceptable"),
            (1000, 1500, "Poor"),
            (1500, 2000, "Very Poor"),
            (2000, float("inf"), "Hazardous"),
        ],
    },
    "Temperature": {
        "unit": "°C",
        "hazardous_threshold": 38,
        "max_recorded": 56.7,
        "bands": [
            (-float("inf"), 5, "Hazardous"),
            (5, 10, "Very Poor"),
            (10, 15, "Poor"),
            (15, 18, "Acceptable"),
            (18, 24, "Good"),
    ...
    "NO2": {
        ...
        "bands": [
            ...
            (100, 360, "Poor"),
            (360, 649, "Very Poor"),
            (649, float("inf"), "Hazardous"),
        ],
    },
    "SO2": {
        "unit": "ppb",
        "hazardous_threshold": 304,
        "max_recorded": 500,
        "bands": [
            (0, 35, "Good"),
            (35, 75, "Acceptable"),
